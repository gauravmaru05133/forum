...
import { deviceHeight, deviceWidth } from "../../utils/variables";
...
const Offer = ({ width, height }: ILayersProps) => {
  const offerImage = useImage(require("../../assets/images/offer.png"));
  return (
    offerImage && (
...
const ScratchPattern = ({ width, height }: ILayersProps) => {
  const scratchPatternImage = useImage(
    require("../../assets/images/scratchMask/mask_1.png")
  );
...
export const ScratchCardComponent = ({ getScratched }) => {
  // Canvas dimensions
  ...
  return (
    <GestureDetector gesture={pan}>
      <View style={styles.container}>
        ...
        {/* {isScratched && (
          <Lottie
            source={require("../../assets/animination/wow_ribon.json")}
            autoPlay
            loop
          />
        )} */}
