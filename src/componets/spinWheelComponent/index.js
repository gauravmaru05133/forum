...
const width = Dimensions.get("window").width / 1.25;
  ...
  _onPress = () => {
    ...
    Animated.timing(this._angle, {
      ...
      this.props?.getWinner(
        this._wheelPaths[winnerIndex].code,
          ...
          >
            <G y={width / 2} x={width / 2}>
              {this._wheelPaths.map((arc, i) => {
                ...
                // console.log("Check Number", number, "Check Arc", arc);
                return (
                  <G key={`arc-${i}`}>
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => this._onPress()}>
          <View style={styles.spinTextWrapper}>
            <RNText style={styles.spinText}>Spin</RNText>
          </View>
        </TouchableOpacity>
        {this._renderKnob()}
      </View>
